...
def inquiry(request):
    if request.method == 'POST':
        ...
        if request.user.is_authenticated:
            ...
            if has_contacted:
                messages.error(request, 'You have already have made an inquiry about this car. Please wait until we get back to you.')
        ...
        message=message, customer_need=customer_need)
